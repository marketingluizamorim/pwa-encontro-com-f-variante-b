    ...
    <PageTransition className="relative w-full h-full flex flex-col items-center">
      ...
      {isEmpty ? (
        ...
        <>
          ...
          <div className="flex-1 w-full max-w-md relative flex items-center justify-center pb-32 px-4">
            ...
            <motion.div
              ...
              className="w-full h-full absolute inset-0 px-4 pt-4 pb-32 z-20 cursor-grab active:cursor-grabbing touch-none"
              initial={false}
