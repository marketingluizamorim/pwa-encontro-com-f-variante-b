        ...
        <PageTransition className="h-[calc(100vh-8rem)]">
            <PullToRefresh onRefresh={handleRefresh} className="h-full">
                <div className="flex flex-col h-full bg-background">
                    {/* Promotional Banner */}
                    <div className="mx-4 mt-4 mb-6 p-4 rounded-xl relative overflow-hidden bg-gradient-to-r from-gray-900 to-black border border-white/10 shadow-lg">
                        <div className="relative z-10 flex gap-4 items-center">
                            ...
                            <div>
                                <h3 className="text-white font-bold text-sm">Saia na frente com as curtidas prioritárias</h3>
                                <p className="text-gray-400 text-xs mt-1">
                                    Chame atenção mais rápido e aumente as suas chances de dar Match em até 30%.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="px-4 mb-8">
                            ...
                            <div className="flex gap-4 overflow-x-auto pb-2 -mx-4 px-4 scrollbar-hide">
                                ...
                                <Link to="/app/matches" className="flex flex-col items-center gap-2 shrink-0 group">
                                    <div className="relative w-24 h-32 rounded-xl overflow-hidden border-2 border-[#d4af37] bg-gray-900 flex items-center justify-center">
                                        <div className="absolute inset-0 bg-cover bg-center opacity-50 blur-sm scale-110" style={{ backgroundImage: `url(${conversations[0]?.profile.avatar_url})` }}></div>
                                        <div className="relative z-10 w-8 h-8 rounded-full bg-[#d4af37] flex items-center justify-center shadow-lg">
                                            <span className="text-black font-bold text-xs">{likesCount}</span>
                                        </div>
                                        <div className="absolute bottom-1 w-full text-center">
                                            <i className="ri-heart-fill text-[#d4af37] text-[10px]"></i>
                                        </div>
                                    </div>
                                    <span className="text-xs font-semibold">{likesCount} curtida{likesCount !== 1 && 's'}</span>
                                </Link>
                                ...
                                {newMatches.map((conv) => (
                                    ...
                                    >
                                        <div className="relative w-24 h-32 rounded-xl overflow-hidden bg-muted shadow-sm">
                                            <img
                                            ...
                                            {conv.last_message && !conv.last_message.is_read && conv.last_message.sender_id !== user?.id && (
                                                <div className="absolute right-1 top-1 w-3 h-3 bg-red-500 rounded-full border-2 border-background"></div>
                                            )}
                                        </div>
